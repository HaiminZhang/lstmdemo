...
function DataLoader.create(opt)
     local loaders = {}
     local tr_ds, te_ds = datasets.createTrainTest(opt)
     print('tr_ds')
     print(tr_ds)
     print('te_ds')
     print(tr_ds)
...
--[[     local loaders = {}
     local dataset = datasets.createTrainTest(opt)
     ...
     --
     --[[return
     loaders[1] = M.DataLoader(dataset, opt, 'train')
...
function DataLoader:__init(dataset, opt, split)
    print('file '..__FILE__()..', LINE '..__LINE__()..', dataset')
    print(dataset)
